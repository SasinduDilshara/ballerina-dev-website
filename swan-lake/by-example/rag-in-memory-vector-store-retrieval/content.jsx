...
export function RagInMemoryVectorStoreRetrieval({ codeSnippets }) {
        ...
        <Col sm={12}>
          <pre ref={ref1}>
            <code className="d-flex flex-column">
              <span>{`\$ bal run rag_in_memory_vector_store_retrieval.bal`}</span>
...
`}</span>
              ...
              <span>{`Answer: A full-time employee can carry forward up to 5 unused annual leave days to the next calendar year.`}</span>
            </code>
          </pre>
        </Col>
      </Row>
      ...
      <ul style={{ marginLeft: "0px" }} class="relatedLinks">
        <li>
          <span>&#8226;&nbsp;</span>
          <span>
            <a href="https://github.com/ballerina-platform/ballerina-distribution/tree/master/examples/rag-in-memory-vector-store-retrieval/leave_policy.md">
      ...
      <Row className="mt-auto mb-5">
        <Col sm={6}>
          <Link
            title="Ingest with OpenRouter embeddings"
            href="/learn/by-example/rag-openrouter-ingestion/"
          >
