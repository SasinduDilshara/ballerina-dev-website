  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      ...
      <p>
        ...
        correlation ID of the request. Since the metadata is not part of the
        tool input schema, the LLM never sees it.
      </p>

      <p>
        A service declared with the{" "}
        <code>mcp:StreamableHttpAdvancedService</code> type receives the whole{" "}
        <code>mcp:CallToolParams</code> in its <code>onCallTool</code> method,
        including the <code>_meta</code> field. The <code>mcp:Meta</code> type
        is an open record, so a client can attach its own fields to it.
      </p>

      <p>
        This example exposes a tool that lists support tickets, and scopes the
        result to the tenant sent in the request metadata.
      </p>
