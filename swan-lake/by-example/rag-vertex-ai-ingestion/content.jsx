...
export function RagVertexAiIngestion({ codeSnippets }) {
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      ...
      <p>
        ...
        instead to persist them. To retrieve the chunks and generate an answer
        with a Gemini model, see the{" "}
      ...
      <blockquote>
        <p>
          Note: Create a Google Cloud service account with access to Vertex AI,
          download its JSON key file, and add the path, the project ID, and the
          location to the <code>Config.toml</code> file (e.g.,{" "}
          <code>serviceAccountKeyPath = &quot;/path/to/key.json&quot;</code>,{" "}
          <code>projectId = &quot;&lt;gcp-project-id&gt;&quot;</code>,{" "}
          <code>location = &quot;us-central1&quot;</code>). Never commit
        ...
        <Col sm={12}>
          <pre ref={ref1}>
            <code className="d-flex flex-column">
              <span>{`\$ bal run rag_vertex_ai_ingestion.bal`}</span>
              <span>{`Ingestion successful`}</span>
              <span>{`Chunks stored: 3`}</span>
              <span>{`- Full-time employees are entitled to 20 days of paid annual leave per year. (dimension: 768)`}</span>
              <span>{`- Employees are entitled to 10 days of paid sick leave per year. (dimension: 768)`}</span>
              <span>{`- Parental leave is 12 weeks and must be requested one month in advance. (dimension: 768)`}</span>
            </code>
          </pre>
        </Col>
      </Row>
      ...
      <Row className="mt-auto mb-5">
        <Col sm={6}>
          <Link
            title="Ingest into Azure AI Search"
            href="/learn/by-example/rag-azure-ai-search-ingestion/"
          >
