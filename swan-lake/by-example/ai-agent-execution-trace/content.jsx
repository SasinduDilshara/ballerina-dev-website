...
export function AiAgentExecutionTrace({ codeSnippets }) {
    ...
    <Container className="bbeBody d-flex flex-column h-100">
        ...
        <Col sm={12}>
          <pre ref={ref1}>
            <code className="d-flex flex-column">
              <span>{`\$ bal run ai_agent_execution_trace.bal`}</span>
              <span>{`Query: Is product P-100 running low, and is more stock on the way?`}</span>
              <span>{`Iterations: 3`}</span>
              <span>{`Iteration 1:`}</span>
              <span>{`  Tool 'getStockLevel' returned: 3`}</span>
              <span>{`Iteration 2:`}</span>
              <span>{`  Tool 'getUnitsOnOrder' returned: 50`}</span>
              <span>{`Iteration 3:`}</span>
              <span>{`  Assistant: Product P-100 currently has a stock level of 3, which is low. However, there are 50 units on order from suppliers.`}</span>
              <span>{`Tool calls: ["getStockLevel","getUnitsOnOrder"]`}</span>
              <span>{`Final answer: Product P-100 currently has a stock level of 3, which is low. However, there are 50 units on order from suppliers.`}</span>
              <span>{`Duration: 6.539017s`}</span>
            </code>
          </pre>
        </Col>
      </Row>
      ...
      <ul style={{ marginLeft: "0px" }} class="relatedLinks">
        <li>
          ...
          <span>
            <a href="https://central.ballerina.io/ballerinax/amp/latest">
              The <code>ballerinax/amp</code> module
            </a>
          </span>
        </li>
      </ul>
