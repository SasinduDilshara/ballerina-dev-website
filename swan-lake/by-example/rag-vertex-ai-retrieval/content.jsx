...
export function RagVertexAiRetrieval({ codeSnippets }) {
        ...
        <Col sm={12}>
          <pre ref={ref1}>
            <code className="d-flex flex-column">
              <span>{`\$ bal run rag_vertex_ai_retrieval.bal`}</span>
              <span>{`Match: Full-time employees are entitled to 20 days of paid annual leave per year. (score: 0.715567378480986)`}</span>
              <span>{`Match: Parental leave is 12 weeks and must be requested one month in advance. (score: 0.6633565934701463)`}</span>
              <span>{`
`}</span>
              <span>{`Answer: Full-time employees are entitled to 20 days of paid annual leave per year.`}</span>
            </code>
          </pre>
        </Col>
      </Row>
