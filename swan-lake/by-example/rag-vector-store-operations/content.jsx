...
export function RagVectorStoreOperations({ codeSnippets }) {
        ...
        <Col sm={12}>
          <pre ref={ref1}>
            <code className="d-flex flex-column">
              <span>{`\$ bal run rag_vector_store_operations.bal`}</span>
              <span>{`Entries added: 3`}</span>
              <span>{`
`}</span>
              <span>{`Top matches:`}</span>
              <span>{`- Full-time employees are entitled to 20 days of paid annual leave per year. (score: 0.45539822179130923)`}</span>
              <span>{`- Employees are entitled to 10 days of paid sick leave per year. (score: 0.43790068501441337)`}</span>
              <span>{`
`}</span>
              <span>{`Top matches with topic == expenses:`}</span>
              <span>{`- Expense reports must be submitted within 30 days of travel. (score: 0.2734506430516995)`}</span>
              <span>{`
`}</span>
              <span>{`Entries after deleting chunk-3: 2`}</span>
            </code>
          </pre>
        </Col>
      </Row>
