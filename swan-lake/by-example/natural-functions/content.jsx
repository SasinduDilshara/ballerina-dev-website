...
export function NaturalFunctions({ codeSnippets }) {
    ...
    <Container className="bbeBody d-flex flex-column h-100">
        ...
        <Col sm={12}>
          <pre ref={ref1}>
            <code className="d-flex flex-column">
              <span>{`\$ bal run --experimental natural_functions.bal`}</span>
              <span>{`Sentiment: positive (confidence: 0.9)`}</span>
              <span>{`Topics: ["cleanliness","staff","location","noise"]`}</span>
              <span>{`Summary: The hotel stay was positive with a spotless room and helpful staff, although street noise at night was a downside.`}</span>
            </code>
          </pre>
        </Col>
      </Row>
      ...
      <ul style={{ marginLeft: "0px" }} class="relatedLinks">
        <li>
          <span>&#8226;&nbsp;</span>
          <span>
            <a href="/learn/by-example/natural-expressions-with-model-provider/">
              The Natural expressions with a specific model provider example
            </a>
          </span>
        </li>
      </ul>
      ...
      <ul style={{ marginLeft: "0px" }} class="relatedLinks">
        <li>
          <span>&#8226;&nbsp;</span>
          <span>
            <a href="https://central.ballerina.io/ballerina/ai.np/latest">
              The <code>ballerina/ai.np</code> module
            </a>
          </span>
        </li>
      </ul>
