...
export function RagOpenrouterIngestion({ codeSnippets }) {
    ...
    <Container className="bbeBody d-flex flex-column h-100">
      ...
      <ul style={{ marginLeft: "0px" }} class="relatedLinks">
        <li>
          ...
          <span>
            <a href="/learn/by-example/rag-openrouter-retrieval/">
              The Retrieve and generate with OpenRouter example
            </a>
          </span>
        </li>
      </ul>
        ...
        <li>
          ...
          <span>
            <a href="/learn/by-example/rag-vertex-ai-ingestion/">
              The Ingest with Google Vertex AI embeddings example
            </a>
          </span>
        </li>
      </ul>
