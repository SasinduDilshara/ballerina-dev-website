...
export function AiAgentToolContext({ codeSnippets }) {
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      ...
      <p>
        This example gives the agent a tool that lists the orders of the
        signed-in customer, with the customer ID supplied through the context.
      </p>
        ...
        <Col sm={12}>
          <pre ref={ref1}>
            <code className="d-flex flex-column">
              <span>{`\$ bal run ai_agent_tool_context.bal`}</span>
              <span>{`You have two orders:`}</span>
              <span>{`- **ORD-1001**: Status is **delivered**`}</span>
              <span>{`- **ORD-1003**: Status is **processing**`}</span>
              <span>{`
`}</span>
              <span>{`You have one order (ORD-1002) that is currently in transit.`}</span>
            </code>
          </pre>
        </Col>
      </Row>
