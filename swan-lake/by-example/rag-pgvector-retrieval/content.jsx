...
export function RagPgvectorRetrieval({ codeSnippets }) {
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      ...
      <blockquote>
        <p>
          Note: Add the database configuration to the <code>Config.toml</code>{" "}
          file (e.g., <code>pgPassword = &quot;&lt;password&gt;&quot;</code>).
          This example also uses the default embedding provider and model
        ...
        <Col sm={12}>
          <pre ref={ref1}>
            <code className="d-flex flex-column">
              <span>{`\$ bal run rag_pgvector_retrieval.bal`}</span>
...
`}</span>
      ...
      <ul style={{ marginLeft: "0px" }} class="relatedLinks">
        <li>
          ...
          <span>
            <a href="/learn/by-example/rag-pgvector-ingestion/">
              The Ingest into pgvector example
            </a>
          </span>
        </li>
      </ul>
