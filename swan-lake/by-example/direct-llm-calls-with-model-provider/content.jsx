...
export function DirectLlmCallsWithModelProvider({ codeSnippets }) {
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      <h1>Direct LLM calls with a specific model provider</h1>
      ...
      <p>
        ...
        , and others implement this type, so the same code works across
        providers.
      </p>
