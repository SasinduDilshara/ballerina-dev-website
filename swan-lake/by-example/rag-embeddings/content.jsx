...
export function RagEmbeddings({ codeSnippets }) {
    ...
    <Container className="bbeBody d-flex flex-column h-100">
      ...
      <blockquote>
        <p>
          ...
          already logged in, log in to the Ballerina Copilot when prompted. For
          more information on the available embedding providers, see{" "}
          <a href="https://wso2.com/integration-platform/docs/genai/develop/components/embedding-providers">
        ...
        <Col sm={12}>
          <pre ref={ref1}>
            <code className="d-flex flex-column">
              <span>{`\$ bal run rag_embeddings.bal`}</span>
              <span>{`Similarity with "How many days of vacation do I get?": 0.49036478798086064`}</span>
              <span>{`Similarity with "Sick leave requires a medical certificate after two days.": 0.39029105430154026`}</span>
              <span>{`Similarity with "The quarterly sales report is due on Friday.": 0.10986640552275799`}</span>
            </code>
          </pre>
        </Col>
      </Row>
