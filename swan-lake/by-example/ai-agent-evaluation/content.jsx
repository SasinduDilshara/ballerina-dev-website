...
export function AiAgentEvaluation({ codeSnippets }) {
  ...
  return (
    <Container className="bbeBody d-flex flex-column h-100">
      ...
      <p>
        ...
        <a href="https://lib.ballerina.io/ballerina/ai.eval/latest/">
          <code>ballerina/ai.eval</code> module
        </a>
        .
      </p>
        ...
        <Col sm={12}>
          <pre ref={ref1}>
            <code className="d-flex flex-column">
              <span>{`\$ bal test agent_evaluation`}</span>
              <span>{`
`}</span>
              <span>{`Compiling source`}</span>
              <span>{`	ballerinatest/agent_evaluation:0.1.0`}</span>
              <span>{`
`}</span>
              <span>{`Running Tests`}</span>
              <span>{`
`}</span>
              <span>{`	agent_evaluation`}</span>
              <span>{`		[pass] testContentCoverage`}</span>
              <span>{`		[pass] testHelpfulness`}</span>
              <span>{`		[pass] testIterationEfficiency`}</span>
              <span>{`
`}</span>
              <span>{`
`}</span>
              ...
              <span>{`
`}</span>
              <span>{`		Test execution time : 15.779s`}</span>
            </code>
          </pre>
        </Col>
      </Row>
      ...
      <ul style={{ marginLeft: "0px" }} class="relatedLinks">
        <li>
          <span>&#8226;&nbsp;</span>
          <span>
            <a href="/learn/test-ballerina-code/write-tests/">
              Test Ballerina code
            </a>
          </span>
        </li>
      ...
      <ul style={{ marginLeft: "0px" }} class="relatedLinks">
        <li>
          ...
          <span>
            <a href="https://central.ballerina.io/ballerina/ai.eval/latest">
              The <code>ballerina/ai.eval</code> module
            </a>
          </span>
        </li>
      </ul>
